      ...
      <div className="max-w-7xl mx-auto px-6 text-center relative z-10">
        ...
        >
          <h2 className="text-5xl md:text-8xl font-black text-white mb-10 tracking-tighter leading-none">
            Let's build <br /> 
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-blue-300 italic">The Next Big Thing.</span>
          </h2>
          
          <p className="text-zinc-500 text-lg md:text-xl max-w-2xl mx-auto mb-16 font-light leading-relaxed">
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center gap-6 mb-20">
            <motion.a 
              ...
              whileTap={{ scale: 0.95 }}
              className="group px-12 py-6 bg-white text-black font-black uppercase text-xs tracking-[0.2em] rounded-2xl hover:bg-blue-600 hover:text-white transition-all duration-300 shadow-2xl flex items-center gap-3"
            >
              <Mail size={16} />
              Drop a Message
          ...
          <div className="flex justify-center gap-8">
            {[
              ...
              >
                <div className="p-4 bg-white/5 rounded-full text-zinc-500 group-hover:text-white group-hover:bg-white/10 transition-all border border-white/5">
                  <social.icon size={20} />
                </div>
